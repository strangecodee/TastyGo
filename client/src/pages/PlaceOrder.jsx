        ...
        <div className='container mt-4'>
            ...
            <main>
                <div class="py-5 text-center">
                    <img class="d-block mx-auto" src={assets.logo} alt="" width="95" height="95" />
                        ...
                        <form className="needs-validation" onSubmit={onSubmitHandler}>
                            <div className="row g-3">
                                <div className="col-sm-6">
                                    ...
                                    <input type="text" className="form-control" id="firstName" placeholder="" name='firstName'  onChange={onChangeHandler} value={data.firstName} required />
                                </div>
                                ...
                                <div className="col-12">
                                    ...
                                    <input type="number" className="form-control" id="phone" placeholder="Enter Your Phone number"  name='phoneNumber' onChange={onChangeHandler} value={data.phoneNumber} required/>
                                ...
                                <div className="col-md-5">
                                    ...
                                    <select className="form-select" id="country"name='state' onChange={onChangeHandler} value={data.state} required>
                                ...
                                <div className="col-md-4">
                                    ...
                                    <select className="form-select" id="state" name='city' onChange={onChangeHandler} value={data.city} required>
                                        <option value="">Choose...</option>
                                ...
                                <div className="col-md-3">
                                    ...
                                    <input type="number" className="form-control" id="zip" placeholder="Enter Zip/Pin" name='zip' onChange={onChangeHandler} value={data.zip}required />
